        ...
        <div class="relative overflow-hidden  max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="px-5 pb-5 mb-4">
            ...
            <div class="flex items-center mt-2.5 mb-5">
              <span class="bg-blue-100 text-blue-800 text-xs font-bold mr-2 py-0.5 rounded dark:bg-blue-200 dark-text-blue-800 whitespace-wrap max-w-xs">
            ...
            <div class="flex items-center justify-between">
              ...
              >
                ...
                {product?.shipping ? (
                  ...
                  <svg
                    class="w-3 h-3 ml-1 text-gray-800 dark:text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 20 20"
