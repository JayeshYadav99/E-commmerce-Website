...
export default function Footer() {
    return (
        <div> <footer className="max-w-screen  bg-slate-900 sm:p-6 dark:bg-gray-800">
            <div className="mx-auto max-w-screen">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3  ">
                        <div className='mr-4'>
                            ...
                            <ul className="text-red-800 text-xl dark:text-gray-400 ">
                                <li className="mb-4">
                                    <a href="https://flowbite.com" className="hover:underline">ShopSage</a>
                                </li>
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:underline">Customer Feedback</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">ShopSage</a>. All Rights Reserved.
                    </span>
