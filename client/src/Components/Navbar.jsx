...
export default function Navbar() {
  ...
  return (
    <div><header>
    <nav className="bg-slate-800 border-gray-200 px-4 lg:px-6 py-2.5 fixed w-full  dark:bg-gray-800 mb-8">
      <div className="flex flex-wrap justify-between items-center">
        ...
        <div className="flex items-center lg:order-2">
          ...
          {/* Dropdown menu */}
          <div class={` z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown ${dropdowns.appsDropdown ? "block" : "hidden"}`} style={{ position: "absolute", right: "1rem", top: "3.5rem" }}>
