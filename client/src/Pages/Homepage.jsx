        ...
        <div className="bg-red-400 max-w-screen dark:bg-gray-900 mb-0 ">
          <div className="grid max-w-screen-2xl px-2 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
            <div className="mr-auto place-self-center lg:col-span-7">
              <h1 className="mb-4 text-2xl font-extrabold text-gray-900 dark:text-white md:text-3xl md:mt-8 lg:text-4xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-green-500 from-purple-900">  Unlock Limitless Shopping: Elevate Your Retail Experience with Exclusive Deals and Exciting Finds!
              </span> </h1>
            ...
            <div className="hidden  ml-8 lg:mt-0 lg:col-span-5 lg:flex">
              <img
