...
{/* Intro section*/}
  ...
  <h2 class="mb-4 mr-2 text-7xl tracking-tight font-bold text-gray-900 dark:text-white">Features</h2>
</div>
...
<img src="32-removebg-preview.png"  style={{ width:"300px"}}class=" ml-10  mr-0 relative right-0 bottom-0" />
