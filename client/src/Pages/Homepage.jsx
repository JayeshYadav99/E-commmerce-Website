...
<Imageslider/>
 ...
 {/* Footer*/}
 <footer class="max-w-screen  bg-slate-900 sm:p-6 dark:bg-gray-800">
    <div class="mx-auto max-w-screen">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="/" class="hover:underline">ShopSage</a>. All Rights Reserved.
            </span>
