...
Setproducts(data.products);
  ...
  return (
    <Layout title={"Dashboard - Create Product"}>
     <div className="flex">
        ...
        <div className="flex justify-end mb-4">
            <button
              className={`mr-2 ${viewMode === 'grid' ? 'text-primary-700' : 'text-gray-700'} hover:text-primary-800 focus:outline-none`}
              onClick={() => setViewMode(!viewMode)}
            >

                {(viewMode) ?(<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6.143 1H1.857A.857.857 0 0 0 1 1.857v4.286c0 .473.384.857.857.857h4.286A.857.857 0 0 0 7 6.143V1.857A.857.857 0 0 0 6.143 1Zm10 0h-4.286a.857.857 0 0 0-.857.857v4.286c0 .473.384.857.857.857h4.286A.857.857 0 0 0 17 6.143V1.857A.857.857 0 0 0 16.143 1Zm-10 10H1.857a.857.857 0 0 0-.857.857v4.286c0 .473.384.857.857.857h4.286A.857.857 0 0 0 7 16.143v-4.286A.857.857 0 0 0 6.143 11Zm10 0h-4.286a.857.857 0 0 0-.857.857v4.286c0 .473.384.857.857.857h4.286a.857.857 0 0 0 .857-.857v-4.286a.857.857 0 0 0-.857-.857Z"/>
            ...
            <h3 className="text-base font-semibold leading-7 text-gray-900 mb-4 ">Products</h3>
          
      {viewMode ? (    <section className="bg-gray-50 dark:bg-gray-900 py-3 sm:py-5">
...
/>
               ...
               <td className="px-4 py-2">
                 <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{product?.category?.name}</span>
               </td>
  ...
  </svg>):(<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
